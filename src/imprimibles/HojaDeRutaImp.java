...
public class HojaDeRutaImp extends JFrame implements Printable{
	 ...
	 * @param <T>
	 */
	public HojaDeRutaImp(Comercio comercio, ArrayList<Remito> remitos) {
